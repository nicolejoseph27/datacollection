            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="machineVariable.variable.label" default="Variable" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: machineVariableInstance, field: "variable")}</td>
